...
class BTreeIndex {
 ...
 public:
  ...
  const void updateRoot(T midpagekey);
  /**
  ...
  **/
  ...
  PageKeyPair<T> insertRecursive(PageId root,  RIDKeyPair<T> ridkey);
  ...
  **/
  template <class T, class nonleaf_T>
  PageId findPageNoInNonLeaf(PageId currentNode, RIDKeyPair<T> ridkey);
  ...
  **/
  ...
  PageKeyPair<T> splitLeafNode(PageId leafNo, RIDKeyPair<T> ridkey);
  ...
  **/
  template <class T, class nonleaf_T>
  PageKeyPair<T> splitNonLeafNode(PageId nonLeafNo, PageKeyPair<T> leftpagekey, PageKeyPair<T> rightpagekey);
  ...
  **/
  template <class T, class nonleaf_T, class leaf_T>
  const void typeScan(T lowValParm, const Operator lowOpParm,T highValParm, const Operator highOpParm);
  ...
  **/
  template<class T> 
  bool compare(const Operator op, T left, T right);
  /**
  ...
  **/
  template <class T, class leaf_T>
  const void typescanNext(T lowValParm, T highValParm, RecordId& outRid);
